...
public class MainActivity extends AppCompatActivity implements RestaurantListAdapter.RestaurantListClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        TextView  textView= (TextView) findViewById(R.id.addToCartBtn);
        RestaurantModel restaurantModel2 = getIntent().getParcelableExtra("RestaurantModel");
        if(restaurantModel2 != null)
        {
            textView.setVisibility(View.VISIBLE);
            textView.setOnClickListener(view -> {
                Intent intent2= new Intent(MainActivity.this,CartActivity.class);
                intent2.putExtra("RestaurantModel2",restaurantModel2);
